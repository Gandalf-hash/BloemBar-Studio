  ...
  return (
    <Section id="fixed-target" className="about">
      ...
      <Left data-scroll data-scroll-sticky data-scroll-target="#fixed-target">
        We're fashion studio based in the Free State, Bloemfontein. We create unique designs that
        will blow your mind. We also design unique jewelery pieces. Fashion is an
