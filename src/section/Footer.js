...
const Footer = () => {
  ...
  return (
    <Section>
      <LogoContainer>
        <img data-scroll data-scroll-speed="2" src={Logo} alt='Bloem Studio' />
        <h3 data-scroll data-scroll-speed="-1">Bloem Studio</h3>
      </LogoContainer>
      <FooterComponent
      initial={{y: "-400"}}
      whileInView={{y:0}}
      ...
      transition={{duration:1.5}}>
        ...
        <Bottom>
            ...
            <a href="https://www.linkedin.com/in/tshepiso-johannes-a19353204/" target="-blank" rel="noreferrer">
                TJ&nbsp;Phetoane
               </a>
            </span>
        </Bottom>
